$(document).ready(function() {
  $('.js-youtube-play').click(function() {
    ...
    $(this).parent('.video--big').append(`<iframe src="https://www.youtube.com/embed/${$(this).data('id')}?autoplay=1&autohide=1&version=3&hl=ru_RU&rel=0" frameborder="0" style="width: 100%; height: 530px;"></iframe>`)
